...
int main() {
    ...
    // Solicita los elementos del primer arreglo (se asume que está ordenado)
    ...
    // Solicita los elementos del segundo arreglo (se asume que está ordenado)
    printf("Introduce los elementos del segundo arreglo en orden ascendente:\n");
    for (i = 0; i < M; i++) {
        scanf("%d", &VEC2[i]);
    }
